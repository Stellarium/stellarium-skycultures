...
If two stars of comparable brightness are close to each other, they are given a common name like: The two Calves, the Two Wolves, The Two doves.
Sometimes an area is named after a group of animals. The brighter stars are adult animals, and the faint ones are the young animals like: The Hyenas and their youngsters, The horses and the foals.
Particular shapes of stars were given names like the Scorpion, The lion, Al Jawza' which is a proper name of a woman for Orion stars.
...
5.	Al-farāhīdī, Abu Abdul'Raḥmān Al-ḫalīl b. Aḥmad (died ~ 786 AD), Kitab Al-Ayn (The book of Arabic letter العين), (Arabic print of the original book, 1980 – 1985).
...
A simple asterism of the two stars:α Cep and β Cep.
...
##### The northern tent
An asterism of stars representing a tent
##### The young camel
A small asterism of four stars shaped as quadrilateral.
##### The caracal
A single star representing the desert caracal.
##### The bucket rope knot - The well poles
Two adjacent stars imagined as the knot of [the rope of the well bucket](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-well-bucket-rope).
##### The front bucket mouth
The two front bright stars of the big square of Pegasus.
##### The rear bucket mouth
The two rear bright stars of the big square of Pegasus.
##### The well bucket rope
Two joint arcs of stars.
##### The fish
Another name of the stars of [the well bucket rope](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-well-bucket-rope).
##### The well bucket
All the star groups of [the bucket rope knot](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-bucket-rope-knot---the-well-poles), [The front bucket mouth](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-front-bucket-mouth), [The rear bucket mouth](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-rear-bucket-mouth), and [The well bucket rope](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-well-bucket-rope).
##### The two forelegs of the lamb
Two stars representing the two forelegs of [the lamb](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lamb).
##### The two signs
Two stars which are the horn of [the lamb](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lamb).
##### The little abdomen
A triangle of faint stars which are the abdomen of [the lamb](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lamb).
##### Al-Thurayya
...
##### The lamb
A group of stars that consist of [The two forelegs of the lamb](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-two-forelegs-of-the-lamb), [The two signs](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-two-signs) as the lamb horn, [The little abdomen](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-little-abdomen), and [Al-Thurayya]https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#al-thurayya) as the lamb fatty tale.
##### The two dogs of Al-Dabaran
Two adjacent stars representing two dogs of [Al-Dabaran](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#al-dabaran).
##### The young she-camels
A group of stars between the Pleiades and Aldebaran representing young she-camels driven by [Al-Dabaran](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#al-dabaran) to [Al-Thurayya](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#al-thurayya) as a dowry to marry her.
##### Al-Dabaran
...
Two stars representing the end of the shorter arm of the [great Arab lion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lion) image.
##### The extended arm [of the lion]
Two stars representing the end of the longer arm of the [great Arab lion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lion) image.
##### Nostrils [of the lion]
M 44 and two adjacent stars representing the nose tip of the [great Arab lion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lion) image.
##### Eyes [of the lion]
Two stars representing the eyes of the [great Arab lion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lion) image.
##### Forehead [of the lion]
Four stars representing the forehead of the [great Arab lion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lion) image.
##### Mane [of the lion]
Two stars representing the mane of the [great Arab lion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lion) image.
##### The bend
Five stars asterism representing a bent line.
##### The cover
Three stars asterism.
##### The tassel
Coma Berenices representing the tassel of the tale of the [great Arab lion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-lion) image.
##### The lion
A great constellation representing a lion covering a large area of the sky.
##### Claws of the scorpion
Two stars representing the claws of [the scorpion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-scorpion).
##### The diadem
Three stars at the forehead of [the scorpion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-scorpion).
##### Raised Tail of the Scorpion
The stars representing the tail segments of [the scorpion](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-scorpion).
##### The scorpion
The scorpion image.
...
##### The Ostriches
The Constellation that includes:  [The Ostriches drinking at the river](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-ostriches-drinking-at-the-river), [The Ostriches leaving the river](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-ostriches-leaving-the-river), [The Ostrich nest](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-ostrich-nest---the-necklace), [The other Ostrich nest](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-ostrich-nest).
...
An asterism three stars that rises in the morning in the spring.
##### The lucky star of the tents
An asterism of a triangle of three stars and a fourth one inside it, man inside a tent. 
...
##### The circular mark
A small triangle of stars representing a mark on the side of the horse.
##### The string
...
##### Bow of Al-Jawza
Bow of [Al-Jawza](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#al-jawza).
##### Stoopness [of the camel neck]
An asterism of two stars.
##### Stars of abundant rain
An asterism of three stars.
##### Al-Jawza
A constellation representing a woman figure.
##### The front footstool of Al-Jawza
An asterism of four stars shaped as quadrilateral.
##### The rear footstool of Al-Jawza
An asterism of four stars shaped as quadrilateral.
##### The virgins
A group of five stars near [Al-Jawza](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#al-jawza).
##### The ravens
A group of stars with no particular shape.
##### The Ostriches
A group of five stars representing five ostriches.
##### The ostriches nest
The nest near [The Ostriches](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-ostriches-1).
##### The oryxes
An area of stars representing oryxes.
##### The tied camels
A long line of stars representing tied camels.
##### The trough
An incomplete circle of stars representing a trough that holds food for animals.
##### The southern tent
An asterism of four stars shaped as quadrilateral representing a tent.
##### The date clusters
An area of bright stars representing date clusters.
##### The horses and the foals
An area of stars, where the brighter stars represent the adult horses, and the faint ones represent the young foals.
##### The two shrikes
An asterism of two stars.
##### The two doves
An asterism of two stars.
...
An asterism of two stars.
##### The young ostriches
An area of faint stars between [The two male ostriches](https://github.com/kajaji/stellarium-skycultures/blob/master/arabic/description.md#the-two-male-ostriches).
##### The larks
Group of stars shaped as line representing a flock of larks.
##### The sandgrouses
Group of stars shaped as line representing a flock of sandgrouses.
##### The wild asses
An area of stars representing wild asses.
##### The ladder
Group of stars shaped as line.
